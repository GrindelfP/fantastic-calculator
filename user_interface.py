...
# Next lines are of functions, used in user_interface:
...
# Here ends lines of functions, used in user_interface. In next lines starts the program:
...
# Here ends the input. Next lines are of the calculating:
    ...
    print("Your result is -> ", str(calculator.calculate(first_number_as_digit, user_operator,
